...
execute as @a[scores={ssdp.opened_barrel2=1}] at @e[tag=ssdp.root] if entity @e[tag=ssdp.item_frame,distance=...9] at @s anchored eyes run function ssdp:playsound/open
